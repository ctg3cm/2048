...
# Reference: https://www.youtube.com/watch?v=b4XP2IcI-Bg
...
class Game(tk.Frame):
    def __init__(self):
        ...
        # make the outline/frame
        self.main_grid = tk.Frame(
            self, 
            bg = c.GRID_COLOR, # set background color
            bd = 4, # set border 4 pixels
            width = 400, 
            height = 400
        )
        self.main_grid.grid(pady=(100, 0)) # add padding on the top
        self.make_GUI()
        self.start_game()
    ...
    # comprass all non-zeros and close gap
    def stack(self):
    ...
    # adds all horizontally non-zeros to the left
    def combine(self):
        for i in range(4):
            for j in range(3):
    ...
    def left(self, event):
        self.stack() # to left
        self.combine() # horizontal numbers
        self.stack() # eliminate newly created zero cells
        self.add_new_tile()
        self.update_GUI()
        self.game_over()
    ...
    def right(self, event):
        self.reverse() # reverse to go right
        self.stack()
        self.combine()
        self.stack()
        self.reverse() # reverse back
        self.add_new_tile()
        self.update_GUI()
        self.game_over()
    ...
    def up(self, event):
        self.transpose() # transpose to go up 
        self.stack()
        self.combine()
        self.stack()
        self.transpose()
    ...
    def down(self, event):
        self.transpose() # transpose to go up
        self.reverse() # reverse to go down
        self.stack()
        self.combine()
        self.stack()
        self.reverse()
